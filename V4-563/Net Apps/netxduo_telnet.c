...
void    tx_application_define_telnet(void *first_unused_memory)
{
...
void    thread_server_entry_telnet(ULONG thread_input)
{
...
void    thread_client_entry_telnet(ULONG thread_input)
{
