...
Arch/%.o Arch/%.su Arch/%.cyclo: ../Arch/%.c Arch/subdir.mk
...
clean-Arch:
	-$(RM) ./Arch/DCC.cyclo ./Arch/DCC.d ./Arch/DCC.o ./Arch/DCC.su ./Arch/port.cyclo ./Arch/port.d ./Arch/port.o ./Arch/port.su
