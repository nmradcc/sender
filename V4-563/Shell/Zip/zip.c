 ...
 */
int zip(FILEHANDLE in, FILEHANDLE out)
...
//tp    len = read(ifd, buf, size);
	// FILEHANDLE fhandle sfs_fopen((char const *filename, const char *mode))
	//int vfsfs_read(int fd, PFBYTE buf, word count)
